-- Drop database if exists and start fresh
...
-- Create views
CREATE OR REPLACE VIEW BestsellingBooks AS
SELECT 
    b.book_id,
    b.title,
...
CREATE OR REPLACE VIEW AuthorPerformance AS
SELECT 
    a.author_id,
    CONCAT(a.first_name, ' ', a.last_name) AS author_name,
...
FROM Books b
LEFT JOIN Order_Details od ON b.book_id = od.book_id
GROUP BY b.book_id, b.title, b.stock_quantity, b.price;
